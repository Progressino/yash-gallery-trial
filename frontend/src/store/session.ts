...
const empty: CoverageResponse = {
  ...
  daily_inventory_history_min_date: undefined,
  daily_inventory_history_max_date: undefined,
  daily_inventory_history_uploaded_at: undefined,
  daily_inventory_history_filename: undefined,
  inventory_snapshot_stale: false,
  daily_inventory_history_stale: false,
  inventory_staleness_warnings: undefined,
