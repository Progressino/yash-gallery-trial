  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2">
        {[
          ['Planned', fmt(kpis.planned_qty), 'text-[#002B5B]'],
          ['Issued', fmt(kpis.issued_qty), 'text-blue-700'],
          ['Received', fmt(kpis.received_qty), 'text-emerald-700'],
          ['Balance', fmt(kpis.balance_qty), 'text-amber-700'],
          ['Pending JOs', fmt(kpis.pending_jos), 'text-amber-800'],
          ['Over', fmt(kpis.over_qty), 'text-rose-700'],
          ['Under / Partial', fmt(kpis.under_qty), 'text-orange-700'],
        ].map(([l, v, c]) => (
