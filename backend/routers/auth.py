...
def _login_payload(user: dict) -> dict:
    ...
    return {
        ...
        "hrm_scope": {
            ...
            "can_edit_assignments": hrm_scope.can_edit_assignments,
            "can_view_employee_list": hrm_scope.can_view_employee_list,
            "can_delete_hrm_records": hrm_scope.can_delete_hrm_records,
            "role": hrm_scope.role,
        },
